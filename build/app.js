  ...
  class GameCoordinator {
    constructor() {
      ...
      this.mazeArray = [
        ...
        ['XoooXoooXoXXXooXooXXXoXXoooX'],
        ['XoooXoooXoooXoX XoX XoX XooX'],
        ['XoooXoooXooXooXXXoX XoX XooX'],
        ['XoooXoooXoXoooXoXoXXooX XooX'],
        ['XoooXoooXoXoooXoXoXoXoX XooX'],
        ['XoooXXXoXoXXXoXoXoXoXoXXoooX'],
        ['XooooooooooooooooooooooooooX'],
        ['XooooooXXXXX    XXXXXooooooX'],
        ['XooooooXXXXX    XXXXXooooooX'],
        ['XooooooXX          XXooooooX'],
        ['XooooooXX XXXXXXXX XXooooooX'],
        ['XooooooXX X      X XXooooooX'],
        ['Xoooooo   X      X   ooooooX'],
        ['XooooooXX X      X XXooooooX'],
        ['XooooooXX XXXXXXXX XXooooooX'],
        ['XooooooXX          XXooooooX'],
        ...
        ['XooooooooooooooooooooooooooX'],
        ['XooooooooooooooooooooooooooX'],
        ['XoooooXoooXooXXooXoooXoooooX'],
        ['XoooooXXoXXoX  XoXXooXoooooX'],
        ['XoooooXoXoXoXXXXoXoXoXoooooX'],
        ['XoooooXoooXoXooXoXoXoXoooooX'],
        ['XoooooXoooXoXooXoXooXXoooooX'],
        ['XoooooXoooXoXooXoXoooXoooooX'],
        ['XooooooooooooooooooooooooooX'],
        ['XXXXXXXXXXXXXXXXXXXXXXXXXXXX'],
      ];
